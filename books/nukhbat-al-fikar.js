...
XenosBooks.register({
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        { label: 'The 12 طبقات (Ṭabaqāt) — p.100-101', text: 'From the Ṣaḥābah down through generations of Tābiʿūn and their students, ending with scholars like al-Tirmidhī — based on Taqrīb al-Tahdhīb.' },
        { label: 'الجرح (Al-Jarḥ) — Criticism Ranks (p.102)', text: 'From lightest ("Layyin" / "something is said about him") to worst ("the greatest liar of his time").' },
        { label: 'التعديل (Al-Taʿdīl) — Praise Ranks (p.103)', text: 'From lightest ("Maqbūl, only with a corroborator") to highest ("the most reliable of people").' },
