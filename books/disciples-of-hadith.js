  ...
  sections: [
    ...
    },
    {
      ...
      quiz: [
        ...
        { q: 'What two obligations does al-Khaṭīb say the "Convey from me" hadith creates at once?', choices: ['Memorize the Qur\'an and teach Arabic', 'Transmit what was heard, and never distort it', 'Travel widely and collect wealth', 'Debate opponents and win arguments'], correct: 1 },
    ...
    },
    {
      ...
      quiz: [
        ...
        { q: 'In which two collections is the "Islam began strange" ḥadīth found, according to this section?', choices: ['Only in al-Muwaṭṭaʾ', 'Ṣaḥīḥ Muslim and Ibn Mājah', 'Only in a single obscure manuscript', 'Ṣaḥīḥ al-Bukhārī and Sunan Abī Dāwūd'], correct: 1 },
        { q: 'In another narration cited in this section, how were the strangers described more specifically?', choices: ['As the wealthiest members of society', 'As the scholars of ḥadīth from the early generations', 'As the rulers of distant lands', 'As anyone born outside Arabia'], correct: 1 },
    ...
    },
    {
      ...
      quiz: [
        ...
        { q: 'What are the three specific threats this hadith says the "just people" refute?', choices: ['Poverty, illness, and war', 'The corruption of extremists, the distortions of falsifiers, and the interpretations of the ignorant', 'Foreign invasion, famine, and drought', 'Heresy, apostasy, and disbelief generally, with no further detail'], correct: 1 },
    ...
    },
    {
      ...
      quiz: [
        ...
        { q: 'What comparison did ʿUthmān ibn Abī Shaybah make about hadith scholars, even in a moment of commotion?', choices: ['That they were no different from ordinary worshippers', 'That the corrupt one among them is better than the devout worshipper who is not one of them', 'That their commotion proved they lacked discipline', 'That worship always outweighs hadith study'], correct: 1 },
    ...
    },
    {
      ...
      quiz: [
        ...
        { q: 'What did Abū Dāwūd say would have happened had it not been for "this group," the people of ḥadīth?', choices: ['Islam would have been studied identically regardless', 'We would not have studied Islam', 'Only the Qur\'an would have survived, without the Sunnah', 'Nothing would have changed'], correct: 1 },
    ...
    },
    {
      ...
      quiz: [
        ...
        { q: 'What did Sufyān al-Thawrī say hearing ḥadīth provides for one seeking the Hereafter specifically?', choices: ['Wealth', 'Integrity', 'Fame among scholars', 'Physical strength'], correct: 1 },
    ...
    },
    {
      ...
      quiz: [
        ...
        { q: 'What did al-Dāraquṭnī request when he fell ill, according to this section?', choices: ['A physician', 'That the companions of ḥadīth come and recite ḥadīth to him', 'To be left alone in silence', 'That his family recite the Qur\'an only'], correct: 1 },
      ]
    },
    {
      ...
      quiz: [
        ...
        { q: 'What four things did Yazīd attribute his good outcome to in the dream, besides ḥadīth transmission?', choices: ['Wealth, lineage, fame, and eloquence', 'Speaking the truth, honesty in narrating, long prayer, and patience under poverty', 'Physical strength, travel, marriage, and children', 'Nothing else — only ḥadīth mattered'], correct: 1 },
