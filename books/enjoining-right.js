  ...
  sections: [
    {
      ...
      quiz: [
        { q: 'According to Ibn Taymiyyah, what made the Prophet ﷺ\'s message more complete than those of earlier prophets?', choices: ['It enjoined all good and forbade all evil without exception', 'It contained no laws at all, only spirituality', 'It was revealed faster than earlier messages', 'It was intended only for the Arabs'], correct: 0 },
        { q: 'What Qur\'anic description does Ibn Taymiyyah use for "the best nation"?', choices: ["Qur'an 3:110 — enjoining right, forbidding wrong, believing in Allah", 'A description limited to scholars only', 'A verse about the Day of Judgement exclusively', 'A description of wealth and status'], correct: 0 },
        ...
        { q: 'How does Abū Hurayrah describe this Ummah\'s role toward others, according to this section?', choices: ['As silent observers who never intervene', 'As scholars who only write books, not act', 'As a people focused solely on their own salvation', 'As people who "tie them in chains and shackles and drag them off to Paradise"'], correct: 3 },
    ...
    },
    {
      ...
      quiz: [
        ...
        { q: 'What did Abū Bakr warn would happen if people see a wrongdoer and do not "seize his hand"?', choices: ['Nothing at all — individual sin never affects the group', 'The obligation would be permanently cancelled', 'The wrongdoer would automatically repent on his own', 'Allah is about to inflict them with a general punishment'], correct: 3 },
    ...
    },
    {
      ...
      quiz: [
        ...
        { q: 'What is the "third motivator" toward evil that Ibn Taymiyyah describes?', choices: ['Financial reward for wrongdoing', 'Complete isolation from society', 'Government legislation', 'People of evil loving those who agree with their sin and hating those who abstain'], correct: 3 },
    ...
    },
    {
      ...
      quiz: [
        ...
        { q: 'According to the striking political principle Ibn Taymiyyah cites, which state does Allah "establish"?', choices: ['Any Muslim state regardless of its justice', 'Whichever state has the largest population', 'Only a state ruled by scholars', 'The just state, even if it is disbelieving'], correct: 3 },
    ...
    },
    {
      ...
      quiz: [
        ...
        { q: 'What does Ibn Taymiyyah say happens to an act of enjoining/forbidding whose harm exceeds its benefit?', choices: ['It remains a good deed regardless of outcome', 'It is judged solely by the enjoiner\'s intention, regardless of outcome', 'It is simply postponed until conditions improve', 'It becomes ḥarām, since net harm has exceeded net benefit'], correct: 3 },
    ...
    },
    {
      ...
      quiz: [
        ...
        { q: 'Is merely having natural likes and dislikes considered sinful in itself, according to this section?', choices: ['Yes, all natural inclinations are sinful by default', 'The section takes no position on this', 'Only dislikes are sinful, likes are always permitted', 'No — only acting on them without any basis from Allah and His Messenger ﷺ is blameworthy'], correct: 3 },
    ...
    },
    {
      ...
      quiz: [
        ...
        { q: 'What does this section say is a near-certainty for anyone who genuinely enjoins right?', choices: ['Immediate universal praise and agreement', 'Formal recognition from the ruler', 'Financial reward from the community', 'Persecution and pushback'], correct: 3 },
